...
namespace MOOS.GUI
{
	public static class Lockscreen
	{
		...
		public static void Initialize()
		{
			...
			{
				Framebuffer.Graphics.Clear(Color.Black.ToArgb());
				Framebuffer.Graphics.DrawImage((Framebuffer.Width / 2) - (DesktopManager.Wallpaper.Width / 2), (Framebuffer.Height / 2) - (DesktopManager.Wallpaper.Height / 2),i, (byte)a0.Value);
				Framebuffer.Update();
			}
			a0.Dispose();
