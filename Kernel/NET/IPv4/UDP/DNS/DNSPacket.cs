...
namespace MOOS.NET.IPv4.UDP.DNS
{
    /// <summary>
    ...
    public class DNSPacketAsk : DNSPacket
    {
        ...
        /// <exception cref="ArgumentException">Thrown if RawData is invalid or null.</exception>
        public DNSPacketAsk(Address source, Address dest, string url) : base(source, dest, 1, (ushort)(5 + url.Length + 1))
        {
            int b = 0;
            ...
            for (int i = 0; i < items.Length; i++)
            {
                ...
                {
                    RawData[this.DataOffset + 20 + b] = word[c];
                    b++;
                }
    ...
    public class DNSPacketAnswer : DNSPacket
    {
        ...
        protected override void InitFields()
        {
            ...
            {
                 Debug.WriteLine("DNS Packet response not OK. Passing packet.");
                return;
            }
