...
namespace MOOS.Driver
{
    public class PCIDevice
    {
        ...
        public PCIHeaderType HeaderType;
        public PCIBist BIST;
        public PCIInterruptPIN InterruptPIN;
        ...
        public PCIDevice(ushort Bus, ushort Slot, ushort Function)
        {
            this.Bus = Bus;
            this.Slot = Slot;
        ...
        public static ushort GetHeaderType(ushort Bus, uint Slot, ushort Function)
        {
            uint xAddr = PCI.GetAddressBase(Bus, Slot, Function) | 0xE & 0xFC;
        ...
        public static ushort GetVendorID(ushort Bus, uint Slot, ushort Function)
        {
            uint xAddr = PCI.GetAddressBase(Bus, Slot, Function) | 0x0 & 0xFC;
            IO.ConfigAddressPort.DWord = xAddr;
