using CosmosNetwork.NET.ARP;
using CosmosNetwork.NET.IPv4.TCP;
using CosmosNetwork.NET.IPv4.UDP;
using CosmosNetwork.NET.IPv4.UDP.DHCP;
using System;
using System.Collections.Generic;
using System.Diagnostics;

namespace CosmosNetwork.NET.IPv4
{
    /// <summary>
    ...
    public class IPPacket : EthernetPacket
    {
        ...
        public IPPacket(byte[] rawData): base(rawData)
        {
        }
